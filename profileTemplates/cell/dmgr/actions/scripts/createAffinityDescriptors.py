...
#
# createAffinityDescriptor  - creates default session affinity descriptors for various servertypes
#
# @author - atogi
#
#=======================================================================================================================================================
...
servertypes=jarray.array(("application_server", "jboss_server", "weblogic_server", "apache_server", "tomcat_server", "liberty_server", "customhttp_server", "wasce_server"),java.lang.String)
changed=0
...
for k in range(0,len(servertypes),1):
    ...
    if (descriptorId == ""):
        aMode="passive"
        changed=1
        if (servertypes[k] == 'jboss_server' or servertypes[k] == 'tomcat_server' or servertypes[k] == 'liberty_server' or servertypes[k] == 'customhttp_server' or servertypes[k] == 'wasce_server'):
            learned = "false"
            separator = ":"
            aMode = "active-conditional"
        elif (servertypes[k] == 'apache_server'):
            separator = ":"
            altSep = "+"
        elif (servertypes[k] == 'weblogic_server'):
            separator = "!"
        elif (servertypes[k] == 'application_server'):
            learned = "true"
            separator = ":"
            aMode = "active-conditional"
