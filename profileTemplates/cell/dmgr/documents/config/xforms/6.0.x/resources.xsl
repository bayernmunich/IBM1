...
<!--  Remove diagnoseConnectionUsage from resources.xml LI3816-38 -->
<!-- Defect 357348: make removal of diagnoseConnectionUsage property apply to all connection factories -->
<xsl:template match="factories/@diagnoseConnectionUsage"/>  <!--LI3816-38 -->
...
<!-- PK28833 - Change from "Sybase JDBC 2 Driver" providerType to "Sybase JDBC Driver" when going down to a 6.0.2 JDBCProvider or Datasource -->
<xsl:template match="resources.jdbc:JDBCProvider/@providerType">
  <xsl:choose>
    <xsl:when test="../@providerType='Sybase JDBC 2 Driver'">
      <xsl:attribute name="providerType">Sybase JDBC Driver</xsl:attribute>
    </xsl:when>
    <xsl:when test="../@providerType='Sybase JDBC 2 Driver (XA)'">
      <xsl:attribute name="providerType">Sybase JDBC Driver (XA)</xsl:attribute>
    </xsl:when>
    <xsl:otherwise>
...
<xsl:template match="factories/@providerType">
  <xsl:choose>
    <xsl:when test="../@providerType='Sybase JDBC 2 Driver' ">
      <xsl:attribute name="providerType">Sybase JDBC Driver</xsl:attribute>
    </xsl:when>
...
<!-- LI: 3862-5 - Removes the custom property 'propagateClientIdentityUsingTrustedContext' from DB2Universal Providers -->
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='propagateClientIdentityUsingTrustedContext']"/>
...
<!-- 510150.1 -->
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='connectionSharing']"/>
...
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='nonTransactionalDataSource']"/>
<!-- LIDB3293-24 end -->

<!-- 503220 review of RRA properties not in WAS600 -->
...
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='isolationLevelSwitchingSupport']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='connectionCachingEnabled']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='connectionCacheName']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='removeExistingOracleConnectionPoolIfExists']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='validateNewConnection']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='validateNewConnectionRetryCount']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='validateNewConnectionRetryInterval']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='webSphereDefaultIsolationLevel']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='commitOrRollbackOnCleanup']"/>
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='optimizeDB2ForGetUseClose']"/>
...
<xsl:template match="resources.jdbc:JDBCProvider/factories/propertySet/resourceProperties[@name='nondeferredreaper']"/>
