...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Defect 327548.1: Remove PrimaryAdminExt from admin-authz.xml -->
  <xsl:template match="rolebasedauthz:AuthorizationTableExt/authorizations/specialSubjects[@xmi:type='rolebasedauthz:PrimaryAdminExt']"/>
