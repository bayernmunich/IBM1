...
<!-- Remove any 'useContextRootAsPath' attribute from the cookie configuration at ear level.  This was not supported pre-V8.
     F743-32259
-->
...
<!-- Remove any 'useContextRootAsPath' attribute from the cookie configuration at module level.  This was not supported pre-V8.
     F743-32259
-->
<xsl:template match="appdeployment:Deployment/deployedObject/modules/configs/sessionManagement/defaultCookieSettings/@useContextRootAsPath"/>
...
<!-- Remove any 'httpOnly' attribute from the cookie configuration at ear level.  This was not supported pre-V8. -->

<xsl:template match="appdeployment:Deployment/deployedObject/configs/sessionManagement/defaultCookieSettings/@httpOnly"/>

<!-- Remove any 'httpOnly' attribute from the cookie configuration at module level.  This was not supported pre-V8. -->
