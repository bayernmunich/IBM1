...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Remove usePermittedChains attribute and permittedChains -->
  <xsl:template match="sibresources:SIBus/@usePermittedChains"/>
  <xsl:template match="sibresources:SIBus/permittedChains"/>

  <!-- Remove any MQ bus members -->
  <xsl:template match="sibresources:SIBus/busMembers[@mqServer]"/>
