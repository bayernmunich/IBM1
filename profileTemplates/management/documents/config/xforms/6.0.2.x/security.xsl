        ...
        <xsl:element name="{name()}">
           ...
           <xsl:element name="setting">
		    ...
		    <xsl:when test="contains(../keyStores[@xmi:id = current()/setting/@keyStore]/@location,'safkeyring:///') and
                ...
                <!--  BEGIN when keyStore type is JCECCARACFKS in v61 or v7, change it to JCERACFKS so that 602 can handle --> 
                <xsl:choose>
                 <xsl:when test="contains(../keyStores[@xmi:id = current()/setting/@keyStore]/@type,'JCECCARACFKS')">
                    <xsl:attribute name="keyFileFormat">JCERACFKS</xsl:attribute>
                 </xsl:when>
                 <xsl:otherwise>
                ...
                <!--  END when keyStore type is JCECCARACFKS in v61 or v7, change it to JCERACFKS so that 602 can handle --> 
		   ...
		   <xsl:when test="contains(../keyStores[@xmi:id = current()/setting/@trustStore]/@location,'CONFIG_ROOT')">
               ...
               <xsl:attribute name="trustFilePassword">
                ...
                <!-- BEGIN when trustStore type is JCECCARACFKS in v61 or v7, change it to JCERACFKS so that 602 can handle --> 
                <xsl:choose>
                 <xsl:when test="contains(../keyStores[@xmi:id = current()/setting/@keyStore]/@type,'JCECCARACFKS')">
                    <xsl:attribute name="trustFileFormat">JCERACFKS</xsl:attribute>
                 </xsl:when>
                 <xsl:otherwise>
                ...
                <!-- END when trustStore type is JCECCARACFKS in v61 or v7, change it to JCERACFKS so that 602 can handle --> 
             ...
             <xsl:if test="current()/setting/@securityLevel"> 
                ...
                <!-- BEGIN when trustStore type is CUSTOM in v61 or v7, change it to HIGH so that 602 can handle --> 
                <xsl:choose>
                 <xsl:when test="contains(current()/setting/@securityLevel,'CUSTOM')">
                    <xsl:attribute name="securityLevel">HIGH</xsl:attribute>
                 </xsl:when>
                 <xsl:otherwise>
             ...
             <xsl:if test="current()/setting/@keyStore">
                ...
                <xsl:choose>
                 <xsl:when test="contains(../keyStores[@xmi:id = current()/setting/@keyStore]/@type,'JCECCARACFKS')">
                   <xsl:element name="properties">
                     <xsl:attribute name="xmi:id">Property_5</xsl:attribute>
                     <xsl:attribute name="name">com.ibm.ssl.keyStoreType</xsl:attribute>
                     <xsl:attribute name="value">JCE4758RACFS</xsl:attribute>
                   </xsl:element>
                   <xsl:element name="properties">
                     <xsl:attribute name="xmi:id">Property_6</xsl:attribute>
                     <xsl:attribute name="name">com.ibm.ssl.trustStoreType</xsl:attribute>
                     <xsl:attribute name="value">JCE4758RACFS</xsl:attribute>
                   </xsl:element>
                 </xsl:when>
                 <xsl:otherwise>
