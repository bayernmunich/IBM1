...
//F908-38323 var objShellLinkSamplesGallery = wshShell.CreateShortcut(startMenuLocation + "\\" + node + "\\" + leaf +  "\\${PROFILESDIR}\\${PROFILENAME}\\${SAMPLES}.lnk");      
...
//F908-38323 if ( (fileObject.FolderExists(${PROFILEROOT} + "\\installedApps\\${CELLNAME}\\SamplesGallery.ear") ) )
//F908-38323 {
//F908-38323       objShellLinkSamplesGallery.IconLocation = ${WASROOT} + "\\bin\\icons\\samples.ico";
//F908-38323       objShellLinkSamplesGallery.TargetPath = cmd;
//F908-38323       objShellLinkSamplesGallery.Arguments = "/c start /b http://${HOSTNAME}:9080/WSsamples";
...
objShellLinkStartServer.Arguments = "${SERVERNAME}";
...
objShellLinkStopServer.Arguments = "${SERVERNAME}";
