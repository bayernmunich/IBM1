...
var objShellLinkStartServer = wshShell.CreateShortcut(startMenuLocation + "\\" + node + "\\" + leaf + "\\${PROFILESDIR}\\${PROFILENAME}\\${STARTMANAGER}.lnk");
var objShellLinkStopServer = wshShell.CreateShortcut(startMenuLocation + "\\" + node + "\\" + leaf + "\\${PROFILESDIR}\\${PROFILENAME}\\${STOPMANAGER}.lnk");
...
objShellLinkStartServer.Arguments = "dmgr";
objShellLinkStartServer.WorkingDirectory = ${PROFILEROOT} + "\\bin";
objShellLinkStartServer.Description = "${STARTMANAGER}";
...
objShellLinkStopServer.Arguments = "dmgr";
objShellLinkStopServer.WorkingDirectory = ${PROFILEROOT} + "\\bin";
objShellLinkStopServer.Description = "${STOPMANAGER}";
