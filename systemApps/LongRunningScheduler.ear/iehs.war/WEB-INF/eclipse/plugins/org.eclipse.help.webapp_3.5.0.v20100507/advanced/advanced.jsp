...
<body dir="<%=direction%>" onload="onloadHandler()" role="search">

<form name="searchForm" onsubmit="doAdvancedSearch()">
<div style="overflow:auto;height:250px;">
	<table role="presentation" id="searchTable" width="100%" cellspacing=0 cellpading=0 border=0 align=center >
  	...
  	<table role="presentation" id="filterTable" width="100%" cellspacing=0 cellpading=0 border=0 align=center  style="background:transparent;">
...
<div style="height:50px;">
	<table role="presentation" valign="bottom" align="<%=isRTL?"left":"right"%>">
		<tr id="buttonsTable" valign="bottom"><td valign="bottom" align="<%=isRTL?"left":"right"%>">
  			<table role="presentation" cellspacing=10 cellpading=0 border=0 align=<%=isRTL?"left":"right"%>  style="background:transparent;">
				<tr>
					<td>
