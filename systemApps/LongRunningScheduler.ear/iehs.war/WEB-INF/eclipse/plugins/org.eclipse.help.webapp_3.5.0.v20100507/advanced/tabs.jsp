...
<body dir="<%=direction%>" onload="showTab('<%=data.getVisibleView()%>')" role="navigation">

  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" height="100%" valign="middle">
   <tr>
