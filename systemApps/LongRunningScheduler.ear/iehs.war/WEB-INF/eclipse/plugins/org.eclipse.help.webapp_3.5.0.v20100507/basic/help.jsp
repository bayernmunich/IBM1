...
%>
	...
	<frame name="ViewsFrame" title="<%=ServletResources.getString("ignore", ServletResources.getString("ViewsFrame", request), request)%>" src='<%="view.jsp?view="+data.getVisibleView()+"&"+UrlUtil.htmlEncode(request.getQueryString())%>' marginwidth="0" marginheight="0" scrolling="no">
<%
} else {
%>
	<frame name="ViewsFrame" title="<%=ServletResources.getString("ignore", ServletResources.getString("ViewsFrame", request), request)%>" src='<%="view.jsp?view="+data.getVisibleView()+"&"+UrlUtil.htmlEncode(request.getQueryString())%>' marginwidth="0" marginheight="0" scrolling="no">
