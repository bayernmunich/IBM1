...
%>
	<frame name="TabsFrame" title="<%=ServletResources.getString("ignore", ServletResources.getString("HelpToolbarFrame",request), request)%>" src='<%="basic/tabs.jsp"+UrlUtil.htmlEncode(data.getQuery())%>' marginwidth="5" marginheight="5" scrolling="no">
	<frame name="HelpFrame" title="<%=ServletResources.getString("ignore", ServletResources.getString("HelpFrame",request), request)%>" src='<%="basic/help.jsp"+UrlUtil.htmlEncode(data.getQuery())%>' frameborder="no" marginwidth="0" marginheight="0" scrolling="no">
<%
