	...
	<tbody>
	  <tr valign="top">
		 ...
		 <% if (template.equals("service")) { %>
		   ...
		   <tiles:insert page="/com.ibm.ws.console.xdcore/comboBoxLayout.jsp" flush="false">
	         <tiles:put name="formBean" value="<%=actionForm%>" />
       	     <tiles:put name="label" value="<%=labelkey%>" />
       	     <tiles:put name="desc" value="<%=descriptionkey%>" />
       	     <tiles:put name="property" value="<%=actionItem0%>" />
		 ...
		 <% } else if (template.equals("http.rules.routing")) { %>
		   <tiles:insert page="/com.ibm.ws.console.xdcore/httpRoutingRulesLayout.jsp" flush="false">
	         <tiles:put name="formBean" value="<%=actionForm%>" />
       	     <tiles:put name="label" value="<%=labelkey%>" />
       	     <tiles:put name="desc" value="<%=descriptionkey%>" />
       	     <tiles:put name="property" value="<%=actionItem0%>" />
