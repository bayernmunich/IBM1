			   ...
			   <table cellpadding="5" cellspacing="0" role="presentation">
				 ...
				 <tr id="ruleAction<%=refId%>">
				   <td class="table-text-white" valign="top" colspan=2>
                     <tiles:insert page="/com.ibm.ws.console.xdcore/ruleActionLayout.jsp" flush="false">
                 ...
                 <tr>
            	   <td class="table-text" valign="top" colspan=2>
                     <span style="margin-left:1em">
				       ...
				       <html:submit styleClass="buttons_other" property="rule.action.matchrule.validate.button" onclick="<%=setRowIndex%>">
				         <bean:message key="rule.action.matchrule.validate.button" />
				       </html:submit>
                       <input type="button" name="Cancel" value="<bean:message key="button.cancel"  />" class="buttons_other" onclick="showSectionParent('<%=rowindex%>', '<%=refId%>')"/>
                     </span>
                   </td>
				 </tr>
				 <% } %>
