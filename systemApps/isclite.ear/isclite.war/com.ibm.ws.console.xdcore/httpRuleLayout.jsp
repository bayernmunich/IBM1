...
<%@ page import="com.ibm.ws.console.rules.*"%>
...
<fieldset style="border:0px">
	<legend title="<%=ruleCaptionDescription%>" style="display:none"><%=ruleCaption%></legend>
<body class="content" class="table-row">
	<table><tr><td class="table-text">
    <label TITLE='<bean:message key="<%=ruleCaptionDescription%>"/>'>
