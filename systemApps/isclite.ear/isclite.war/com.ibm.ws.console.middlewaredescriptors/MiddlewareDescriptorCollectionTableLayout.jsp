...
<%                       } else {
                     	...
                     	<%  } else if (columnField.equalsIgnoreCase("name")) { %>
                       	...
                       	<%  } else {%>
                       			<iframe class="table-text" role="presentation" title="<%=columnField%>" frameborder="0" scrolling="auto" width="100%" height="30" marginwidth="0" marginheight="0" src="/ibm/console/middlewaredescriptors?&name=<%=name%>&requestData=<%=columnField%>"></iframe>						
                       	<%  }
