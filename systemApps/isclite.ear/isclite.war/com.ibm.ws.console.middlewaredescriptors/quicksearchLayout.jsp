...
<bean:define id="selectedNodeFilter" 	name="<%=collectionForm%>" property="selectedNodeFilter"	scope="session"/>
<bean:define id="selectedClusterFilter" name="<%=collectionForm%>" property="selectedClusterFilter" scope="session"/>
<bean:define id="selectedStatusFilter" 	name="<%=collectionForm%>" property="selectedStatusFilter"  scope="session"/>
...
<%
        ...
        session.setAttribute("searchFilter",searchFilter);
	  	session.setAttribute("selectedNodeFilter",selectedNodeFilter);
        session.setAttribute("selectedClusterFilter",selectedClusterFilter);
        session.setAttribute("selectedStatusFilter", selectedStatusFilter);
