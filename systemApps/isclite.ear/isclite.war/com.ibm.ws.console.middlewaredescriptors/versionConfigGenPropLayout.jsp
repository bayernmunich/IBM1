...
<table class="framing-table" border="0" cellpadding="5" cellspacing="0" width="100%" role="presentation" >
    ...
    <tr>
        <td class="navigation-button-section" nowrap VALIGN="top">
            ...
            <input type="submit" name="applyversion" value="<bean:message key="button.apply"/>" class="buttons_navigation">
            <%}%>
            
            <%if (showOkButton!=null && showOkButton.equals("yes")){ %> 
            
            <input type="submit" name="saveversion" value="<bean:message key="button.ok"/>" class="buttons_navigation">
            
            <%}%>
            
            <%if (showResetButton!=null && showResetButton.equals("yes")){ %>
            
            <input type="reset" name="resetversion" value="<bean:message key="button.reset"/>" class="buttons_navigation">
            ...
            <input type="submit" name="cancelversion" value="<bean:message key="button.cancel"/>" class="buttons_navigation">
            <%}%>
