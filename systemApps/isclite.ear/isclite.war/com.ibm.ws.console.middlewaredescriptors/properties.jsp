...
PropertiesDetailForm propDetailForm = (PropertiesDetailForm) session.getAttribute("com.ibm.ws.console.middlewaredescriptors.form.PropertiesDetailForm");
String propName = propDetailForm.getRefId() +"|" +propDetailForm.getName();
...
%>
    ...
    <tr valign="top">
        ...
        <tiles:insert page="/com.ibm.ws.console.middlewaredescriptors/textFieldLayout.jsp" flush="false">
        <tiles:put name="property" value="<%=item.getAttribute()%>" />
        ...
        <tiles:insert page="/com.ibm.ws.console.middlewaredescriptors/checkBoxLayout.jsp" flush="false">
        <tiles:put name="property" value="<%=item.getAttribute()%>" />
        <tiles:put name="propName" value="<%=propName%>" />
        <tiles:put name="propValue" value="<%=propValue%>" />
        <tiles:put name="isReadOnly" value="<%=isReadOnly%>" />
        ...
        <tiles:insert page="/com.ibm.ws.console.middlewaredescriptors/radioButtonLayout.jsp" flush="false">
        <tiles:put name="property" value="<%=item.getAttribute()%>" />
        <tiles:put name="propName" value="<%=propName%>" />
        <tiles:put name="propValue" value="<%=propValue%>" />
        <tiles:put name="isReadOnly" value="<%=isReadOnly%>" />
