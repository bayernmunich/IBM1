...
<table class="framing-table" border="0" cellpadding="5" cellspacing="0" width="100%" role="presentation" >
    ...
    <tr valign="top">
        ...
        <% } else if (item.getType().equalsIgnoreCase("Password")) { %>
         ...
         <% } else if (item.getType().equalsIgnoreCase("opMode")) { %>
			<bean:define id="mode" name="<%=formName%>" property="opMode" type="java.lang.String"/>
			<%String key = "dynamiccluster." + mode.toLowerCase();%>

			<td class="table-text" valign="top" nowrap>
				<label TITLE="<bean:message key="<%=item.getDescription()%>"/>">
					<bean:message key="<%=item.getLabel()%>" />
				</label>
				<br>	
    ...
    <% } else
        ...
        %>
            ...
            <tr valign="top">
                ...
                <% if (strType.equalsIgnoreCase("opMode")) { %>
					<bean:define id="mode" name="<%=formName%>" property="opMode" type="java.lang.String"/>
					<%String key = "dynamiccluster." + mode.toLowerCase();%>
