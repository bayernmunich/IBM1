            ...
            for(int z=0;z<list_ext.size();z++) {
                ...
                if (nitem.getLink()!=null && nitem.getLink()!="") {
                	if(nitem.getLink().indexOf("parentType=")!=-1) {
                		...
                		link1 = nitem.getLink() + "&parentRefId=" + refId1 + "&contextId=" + contextId + "&perspective=" + perspective ;
           			} else{
	                    ...
	                    if (target == null) {
	                    	if (!nitem.getLink().equals("com.ibm.ws.console.dynamiccluster.forwardCmd.do?forwardName=dcVariableSubstitutionEntry.content.main") &&
	                    	!nitem.getLink().equals("com.ibm.ws.console.dynamiccluster.forwardCmd.do?forwardName=ServerTemplate.config.view&lastPage=dynamiccluster.detail.main&EditAction=true") &&
	                    	!nitem.getLink().equals("com.ibm.ws.console.dynamiccluster.forwardCmd.do?forwardName=ServerODRTemplate.config.view&lastPage=dynamiccluster.detail.main&EditAction=true")) {
	                    	
	                        	link1 = nitem.getLink() + "&contextId=" + contextId;
	                        } else {
	                        	link1 = nitem.getLink();
	                        }
	                    } else {
