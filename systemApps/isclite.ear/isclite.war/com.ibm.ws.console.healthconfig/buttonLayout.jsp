...
<% if (listsize > 0) { %>
    ...
    <%
    // sample context contextId=cells:dabtcCell05:nodes:dabtcCellManager05
    // Role based at the cell level for all 
    int nodesIndex = contextId.indexOf("nodes");
    String contextId_cell = contextId;
    if (nodesIndex > -1) {
         contextId_cell = contextId.substring(0, nodesIndex);
    }
    String contextUri = ConfigFileHelper.decodeContextUri(contextId_cell);
