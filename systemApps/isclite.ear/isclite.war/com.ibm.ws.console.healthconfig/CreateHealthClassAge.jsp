    ...
    <tr valign="top">
       <td class="table-text" nowrap>
          <FIELDSET id="ageFieldset">
             <legend for ="ageFieldset" TITLE="<bean:message key="healthclass.age.healthcondition.description"/>">
                 ...
                 <tr valign="top">
                   <td class="complex-property" nowrap>
                      ...
                      <html:text property="age"
            	       ...
            	       <html:select property="ageUnits" name="<%=actionForm%>" styleId="ageUnits">
