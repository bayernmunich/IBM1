        ...
        <tiles:insert definition="<%=buttons%>" flush="true"/>
            ...
            <%@ include file="/secure/layouts/tableControlsLayout.jspf" %>
				...
				<fieldset style="border:0px; padding:0pt; margin: 0pt;">
					<legend class="hidden"><bean:message key="healthCustomAction"/></legend>
...
<%                       } else {
                     	...
                     	<%  } else if (columnField.equalsIgnoreCase("name")) { %>
                       	...
                       	<%  } else {%>
                       			<iframe class="table-text" frameborder="0" scrolling="auto" width="100%" height="30" marginwidth="0" marginheight="0" 
	                       			role="presentation" title="<%=hcName%>" 
                       				src="/ibm/console/customprocessdefs?&hcName=<%=hcName%>&requestData=<%=columnField%>">
                       			</iframe>
                       	<%  }
