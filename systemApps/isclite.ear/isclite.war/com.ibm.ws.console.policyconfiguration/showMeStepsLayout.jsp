...
<ibmcommon:setPluginInformation pluginIdentifier="com.ibm.ws.console.policyconfiguration" pluginContextRoot=""/>
...
<title><bean:message key="serviceclass.wizard.title"/></title>
...
<html:form action="<%=actionPath%>" name="<%=actionForm%>" styleId="<%=actionForm%>" type="<%=formType%>">
  ...
  <TR>
    <td class="wpsPortletTitle"><b><bean:message key="<%=titleKey%>"/></b></td>
...
<%-- begin: bviars for d318806 -- <DIV ID="ShowMeHelpLink">
<ibmcommon:info image="policy.help.viewlet.image" topic="policy.topology.viewlet"/>
<bean:message key="viewlet.showme"/>
</DIV>
<script>function moveShowMe() {if (document.getElementById("ShowMeHelpLink")) {if (document.getElementById("wasHelpPortlet")) {showmediv = document.createElement("DIV"); showmediv.setAttribute("id","HelpPortletShowMe");targ =  document.getElementById("fieldHelpPortlet").parentNode;showmediv.innerHTML =  "<div style='margin-top:1.25em;margin-left:-0.5em;margin-bottom:0.5em'><b><bean:message key="task.demonstration"/></b></div>"+document.getElementById("ShowMeHelpLink").innerHTML;showmediv.className = "instruction-text";targ.appendChild(showmediv);smhl =  document.getElementById("ShowMeHelpLink");smhlpar = smhl.parentNode;smhlpar.removeChild(smhl); }  } } window.onload = moveShowMe;</script>
-- end: bviars for d318806 --%>
</p>
...
%>
        ...
        <%@ include file="/com.ibm.ws.console.policyconfiguration/helpPortlet.jspf" %>
