 ...
 <%
        if (showItem == true) {
        	buttonsShown = true;
				...
				if ( ( (ctr == 0) && (selectItem.getAttribute().equals("adminAction")) ) ||
  					 ( (ctr == 1) && (selectItem.getAttribute().equals("operationAction")) ) ||
  					 ( (ctr == 2) && (selectItem.getAttribute().equals("modeAction")) ) )
  					 {
...
%>
			                    <tiles:insert page="/com.ibm.ws.console.middlewarenodes/selectLayout.jsp" flush="false">
