...
<html:form action="authenticateAgentAction.do" name="com.ibm.ws.console.middlewarenodes.MiddlewareNodeCollectionForm" type="com.ibm.ws.console.middlewarenodes.topology.MiddlewareNodeCollectionForm">
...
<BR>
<table class="framing-table" border="0" cellpadding="3" cellspacing="1" width="100%" role="presentation" >
<TBODY>
     <tr valign="top">
          <td class="table-text"  nowrap valign="top">
		      <label  for="user" TITLE="<bean:message key="node.agent.start.userid.desc"/>">
	          	<bean:message key="node.agent.start.userid"/>
	          </label>
     ...
     <tr valign="top">
          <td class="table-text">
			  <label for="password" TITLE="<bean:message key="node.agent.start.password.desc" />">
		      	<bean:message key="node.agent.start.password"/>
        	  </label>
        	  <BR>
              <html:password property="password" styleId="password" styleClass="textEntry" size="30" />
		  </td>
     </tr>
	 </TBODY>
	 </TABLE>
