            ...
            <%@ include file="tableControlsLayout.jspf" %>  
				...
				<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="1" WIDTH="100%" SUMMARY="List table" CLASS="framing-table">
					...
					<%
							...
							{
					%>
							<A HREF="<%=formAction%>?SortAction=true&col=<%=columnField%>&order=ASC"><IMG SRC="<%=request.getContextPath()%>/images/<%=defaultIconList[2]%>" BORDER="0" WIDTH="9" align="texttop" HEIGHT="13" ALT="<bean:message key="not.sorted"/>"></A>
					<%
							}
