...
<%
    ...
    if ((actionForm.indexOf("Archive") != -1) || (actionForm.indexOf("Script") != -1)) {
%>

<html:form action="<%=actionPath%>" name="<%=actionForm%>" styleId="<%=actionForm%>" type="<%=formType%>" enctype="multipart/form-data">
  ...
  <TR>
    <TH class="wpsPortletTitle" width="100%">
...
%>
            <TD CLASS="wizard-tabs-on" VALIGN="top" >
              &nbsp;&nbsp;<bean:message key="step.string"/>&nbsp;<%=Integer.toString(stepNumber)%>.<%=subStepNumber++%>:&nbsp;<bean:message key="<%=step.getValue()%>"/>                 
            </TD>
<% } else {  /*zoght*/ %>
            <TD CLASS="wizard-tabs-on" VALIGN="top" >
...
<%
    } else { /// 22222 we handle wasce app here as well.
...
while( i.hasNext() ) {
    ...
    String stepValue = step.getValue();
    
    if(stepValue.endsWith("2")){
    	stepValue = stepValue.split("2")[0];
    }
    %>
 ...
 %>
            ...
            <html:hidden property="currentStep" value="<%=step.getValue()%>" />
            <input TYPE="hidden" id="currentStepText" name="currentStepText" value='<bean:message key="<%=stepValue%>"/>' />
            <TR>
            <TD CLASS="wizard-tabs-image" VALIGN="top" WIDTH="1%">
              <img src="<%=request.getContextPath()%>/images/wwizard_step_current.gif" width="15" height="15" align="left" alt='<bean:message key="current.step"/>'>
            </TD> 
...
%>
            <TD CLASS="wizard-tabs-on" VALIGN="top" >
              &nbsp;&nbsp;<bean:message key="step.string"/>&nbsp;<%=Integer.toString(stepNumber)%>.<%=subStepNumber++%>:&nbsp;<bean:message key="<%=stepValue%>"/>                 
            </TD>
<% } else {  /*zoght*/ %>
            <TD CLASS="wizard-tabs-on" VALIGN="top" >
              <bean:message key="step.string"/>&nbsp;<%=Integer.toString(stepNumber)%>:&nbsp;<bean:message key="<%=stepValue%>"/>                 
            </TD>
            </TR>  
<% } %>
