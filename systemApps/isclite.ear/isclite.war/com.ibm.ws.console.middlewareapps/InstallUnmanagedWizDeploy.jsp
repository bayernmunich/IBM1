...
<table border="0" cellpadding="3" cellspacing="0" width="100%" role="presentation">
    ...
    <tr valign="top">
        <td class="table-text"nowrap>
            ...
            <tiles:insert page="/com.ibm.ws.console.middlewareapps/deploymentPropertiesUnmanagedAppLayout.jsp" flush="true">
                <tiles:put name="actionForm" value="<%=actionForm%>"/>
            </tiles:insert> 
          
            <tiles:insert page="/com.ibm.ws.console.middlewareapps/unmanagedAppsCollectionTable.jsp" flush="true">
                <tiles:put name="actionForm" value="<%=actionForm%>"/>
            </tiles:insert> 
