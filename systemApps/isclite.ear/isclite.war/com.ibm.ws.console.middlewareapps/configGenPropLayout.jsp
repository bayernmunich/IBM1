...
<!-- configGenPropLayout page! -->
<!-- this page is dealing with the general properties, such as Application Name, Application Type, Application Edition, Edition Description. -->
