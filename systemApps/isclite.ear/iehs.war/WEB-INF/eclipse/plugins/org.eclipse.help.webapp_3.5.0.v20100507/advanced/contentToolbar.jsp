...
<% 
	...
	boolean isBookmarkAction = prefs.isBookmarksView() 
		|| prefs.isBookmarksAction() && (data.isMozilla() || data.isIE()) &&!data.isOpera() && !data.isChrome(); // for infocenter, add to favorites supported on IE
...
<jsp:include page="toolbar.jsp">
	<jsp:param name="script" value="advanced/contentActions.js"/>
