-- Path, Component, Release:  UDDI/ws/code/uddi.install/src/database/uddi30crt_20_tables_SQLS.sql, UDDI.v3persistence, WASX.UDDI, o0643.37
-- Version:                   1.1
...
-- Tables from udd30_crt_25_tables_SQLS.sql

ALTER TABLE ibmudi30.tmodel ALTER COLUMN name nvarchar(765) COLLATE SQL_Latin1_General_CP1_CS_AS 

ALTER TABLE ibmudi30.discoveryurl ALTER COLUMN url ntext COLLATE SQL_Latin1_General_CP1_CS_AS 

ALTER TABLE ibmudi30.discoveryurl ALTER COLUMN usetype ntext COLLATE SQL_Latin1_General_CP1_CS_AS 
GO
