-- Path, Component, Release:  UDDI/ws/code/uddi.install/src/database/uddi30crt_50_triggers_SQLS2005.sql,UDDI.v3persistence, WASX.UDDI, o0643.37
-- Version:                   1.1
...
AFTER UPDATE AS
 BEGIN        
	UPDATE ibmudi30.business       
	SET business.modifiedchild = inserted.modifiedchild        
...
CREATE TRIGGER ibmudi30.tr_upd_bservice_p ON ibmudi30.bservice
   ...
   --OF businesskey
	AS
     BEGIN
        UPDATE ibmudi30.busallservice
          SET busallservice.owningbusinesskey = inserted.businesskey
		  FROM inserted
