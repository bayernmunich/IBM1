...
@REM 5724-J08, 5724-I63, 5724-H88, 5724-H89, 5655-N02, 5733-W70 (c) Copyright IBM Corp. 2004, 2010. All Rights Reserved.
...
"%JAVA_HOME%\bin\java" -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Dcmd.properties.file=%TMPJAVAPROPFILE% %WAS_LOGGING% %CONSOLE_ENCODING% com.ibm.ws.bootstrap.WSLauncher com.ibm.xml.xci.internal.cmdline.ExecuteXQuery %*
set RC=%ERRORLEVEL%
