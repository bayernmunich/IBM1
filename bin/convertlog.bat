@REM 5724-J08, 5724-I63, 5724-H88, 5724-H89, 5655-N02, 5733-W70 (C) COPYRIGHT International Business Machines Corp. 2005, 2010
...
%JAVA_EXE% -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Dcmd.properties.file=%TMPJAVAPROPFILE% %WAS_LOGGING% %DEBUG% %CONSOLE_ENCODING% "%CLIENTSAS%" -Dwas.install.root="%WAS_HOME%" "-Duser.install.root=%USER_INSTALL_ROOT%" com.ibm.ws.bootstrap.WSLauncher com.ibm.ws.logging.ConvertLog %*
set RC=%ERRORLEVEL%
