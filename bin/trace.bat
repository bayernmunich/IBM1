@REM 5724-I63, 5724-H88 (C) COPYRIGHT International Business Machines Corp. 1997, 2012
...
set TMPJAVAPROPFILE=
"%JAVA_HOME%\bin\java" -Dcmd.properties.file=%TMPJAVAPROPFILE% %WAS_LOGGING% %DEBUG% %CONSOLE_ENCODING% "%CLIENTSAS%" -Dwas.install.root="%WAS_HOME%" "-Duser.install.root=%USER_INSTALL_ROOT%" com.ibm.ws.bootstrap.WSLauncher com.ibm.ws.trace.Main %*
