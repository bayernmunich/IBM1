...
"%JAVA_HOME%\bin\java" -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Dcmd.properties.file=%TMPJAVAPROPFILE% -Dcom.ibm.ffdc.log="%USER_INSTALL_ROOT%/logs/ffdc/" %WAS_LOGGING% %CONSOLE_ENCODING% com.ibm.ws.bootstrap.WSLauncher com.ibm.ws.webservices.tools.Java2WSDL %*
set RC=%ERRORLEVEL%
