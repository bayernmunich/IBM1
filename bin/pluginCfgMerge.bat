...
"%JAVA_HOME%\bin\java" -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Dcmd.properties.file=%TMPJAVAPROPFILE% %CONSOLE_ENCODING% -Dserver.root="%WAS_HOME%" %USER_INSTALL_PROP% "-Dwas.install.root=%WAS_HOME%" %WAS_LOGGING% com.ibm.ws.bootstrap.WSLauncher com.ibm.websphere.plugincfg.generator.PluginMergeTool %*
set RC=%ERRORLEVEL%
