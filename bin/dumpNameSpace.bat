...
@REM 5724-J08, 5724-I63, 5724-H88, 5724-H89, 5655-N02, 5733-W70 COPYRIGHT (C) International Business Machines Corp., 1997, 2010
@REM US Government Users Restricted Rights - Use, duplication or disclosure
@REM restricted by GSA ADP Schedule Contract with IBM Corp.

@REM Dump Name Space Launcher
...
if defined WAS_ENDORSED_DIRS set JRE_ENDORSED_DIRS="-Djava.endorsed.dirs=%WAS_ENDORSED_DIRS%"

%JAVA_EXE% -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Dcmd.properties.file=%TMPJAVAPROPFILE% "-Dwas.install.root=%WAS_HOME%" %CONSOLE_ENCODING% "%CLIENTSAS%" "%JAASSOAP%" "%CLIENTSSL%" %JRE_ENDORSED_DIRS% "-Dserver.root=%WAS_HOME%" "-Dcom.ibm.ffdc.log=%FFDCLOG%" %WAS_LOGGING% com.ibm.ws.bootstrap.WSLauncher com.ibm.websphere.naming.DumpNameSpace %*
set RC=%ERRORLEVEL%

@REM Cleanup the temporary java properties file and directory.
del %TMPJAVAPROPFILE%
rmdir %TMPWASDIR%
