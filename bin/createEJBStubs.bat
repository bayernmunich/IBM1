...
@REM
@REM createEJBStubs <input jar of ejbs> [options]
@REM 
@REM options:
@REM         -verbose                    : enables verbose output messages
...
@REM MLS...if "%JAASSOAP%"=="" set JAASSOAP=-Djaassoap=off
...
%JAVA_EXE% -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Dcmd.properties.file=%TMPJAVAPROPFILE% %CONSOLE_ENCODING% %USER_INSTALL_PROP% "-Dwas.install.root=%WAS_HOME%" "com.ibm.wsspi.bootstrap.WSPreLauncher" -nosplash -application "com.ibm.ws.bootstrap.WSLauncher" "com.ibm.ws.runtime.CreateEJBStubsCommand" %*
set RC=%ERRORLEVEL%
