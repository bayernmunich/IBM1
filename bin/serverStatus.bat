...
@REM Server Status Utility

@REM Arguments:
@REM
@REM server 	- name of the server
@REM -all	- obtain status for all defined servers
@REM -trace	- turn on trace for the tool
