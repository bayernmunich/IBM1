...
# e.g. wsadmin[.bat|.sh] -f dumpIMPState.py [options]
# for help: wsadmin[.bat|.sh] -f dumpIMPState.py --help
# for auto dump: wsadmin[.bat|.sh] -f dumpIMPState.py --auto
#==============================================================================
...
def printHelp():
    print """
    Syntax:
    \twsadmin -f dumpIMPState.py [options]\n
    \toptions are:
    """
    ...
    print '\n\te.g. wsadmin -f dumpIMPState.py --auto'
...
# The longOpts array defines the long option values dumpIMPState will accept
# Long options passed to dumpIMPState must have the form --name or --name=
#==============================================================================
opts = []
notUsed = []
