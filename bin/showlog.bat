...
%JAVA_EXE% -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Dcmd.properties.file=%TMPJAVAPROPFILE% %WAS_LOGGING% %DEBUG% %CONSOLE_ENCODING% "%CLIENTSAS%" -Dwas.install.root="%WAS_HOME%" "-Duser.install.root=%USER_INSTALL_ROOT%" com.ibm.ws.bootstrap.WSLauncher com.ibm.ejs.ras.ShowLog %*
