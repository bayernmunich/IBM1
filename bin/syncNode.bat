...
@REM 55724-J08, 5724-I63, 5724-H88, 5724-H89, 5655-N02, 5733-W70 (C) COPYRIGHT International Business Machines Corp., 1997, 2010
@REM All Rights Reserved * Licensed Materials - Property of IBM
@REM US Government Users Restricted Rights - Use, duplication or disclosure
@REM restricted by GSA ADP Schedule Contract with IBM Corp.

@REM Node Sync Utility

@REM Arguments:
@REM
@REM cellhost - host name for Cell Manager system
@REM cellport - JMX port number for Cell Manager
...
"%JAVA_HOME%\bin\java" -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Dcmd.properties.file=%TMPJAVAPROPFILE% %WAS_DEBUG% %WAS_TRACE% %CONSOLE_ENCODING% "%CLIENTSOAP%" "%JAASSOAP%" "%CLIENTSAS%" "%CLIENTSSL%" %USER_INSTALL_PROP% "-Dwas.repository.root=%CONFIG_ROOT%" "-Dlocal.cell=%WAS_CELL%" "-Dlocal.node=%WAS_NODE%"  "-Dwas.install.root=%WAS_HOME%" "com.ibm.wsspi.bootstrap.WSPreLauncher" -nosplash -application "com.ibm.ws.bootstrap.WSLauncher" "com.ibm.ws.admin.services.NodeSyncUtility" "%CONFIG_ROOT%" "%WAS_CELL%" "%WAS_NODE%" %*
SET RC=%ERRORLEVEL%
