...
"%JAVA_HOME%\bin\java" -Djava.endorsed.dirs="%WAS_ENDORSED_DIRS%" -Xverify:none -Xms256m -Xmx512m -classpath %wrd_cp% org.eclipse.core.launcher.Main -noupdate -data %WORKSPACE% -application %application% -launch %PARAMS%
goto end
