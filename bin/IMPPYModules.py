...
#          execfile(ModulePath+"IMPPYModules.py" )
#   You can call any of the methods in IMPPYMdules, for example:
...
#
# @param odrNode     The name of the proxy server or ODR node
...
#                 if it does not exists.
#
def findProxyServer(odrNode, anOdrName):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true";
       start = time.clock()
   ...
   for psName in psNames:
       ...
       if (len(psName) > 0 and (psName.find("/"+odrNode) > -1) and (psName.find("/"+anOdrName+"|") > -1)):
             if (showEndTime == "true" and getEnablePerformanceProfile() == "true"):
                 end = time.clock()
...
#
# Finds the proxy server node
#
# @param anOdrName   The name of the proxy server or ODR to look up.
# @return node name  The node name of the proxy server if it exists or None
#                 if it does not exists.
#
def getProxyNode(anOdrName):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true";
       start = time.clock()
   ...
   for psName in psNames:
       ...
       if (len(psName) > 0 and (psName.find("/"+anOdrName+"|") > -1)):
             idx = psName.find("/nodes/")  
             idx1 = psName.find("/",idx+7)   
             nodeName = psName[idx+7:idx1] 
             if (showEndTime == "true" and getEnablePerformanceProfile() == "true"):
                 end = time.clock()
...
#
def findWorkClass(aWCName,aPolicyType,anOdrNode,anOdrName):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true";
       start = time.clock()
   ...
   for wcName in wcNames:
       ...
       if (len(wcName) > 0 and wcName.find(aPolicyType) > -1 and wcName.find("/"+anOdrName+"/") > 0 and wcName.find("/"+anOdrNode+"/") > 0):
          name=AdminConfig.showAttribute(wcName,"name")
          if (aWCName == name):
              if (showEndTime == "true" and getEnablePerformanceProfile() == "true"):
                  end = time.clock()
...
#                       None if it does not exists.
#
def listGenericServerWorkClassIDs(anOdrNode,anOdrName):
   wcNames=AdminConfig.list("WorkClass").split("\n")
   if(getEnablePerformanceProfile() == "true"):
   ...
   for wcName in wcNames:
       ...
       if (wcName.find("/"+anOdrName+"/") > 0):
           if (anOdrNode != None and anOdrNode != ""):
             if (wcName.find("/"+anOdrNode+"/") > 0):
               wcns[k] = wcName
               k += 1
           else:
             wcns[k] = wcName
...
def listWorkClasses():
   ...
   k=0
   wcns=jarray.zeros(items,java.lang.String)
   for wcName in wcNames:
       wcName=wcName.rstrip()
       if (len(wcName) > 0 ):
          name=AdminConfig.showAttribute(wcName,"name")
...
def createGSCRoutingWorkClass(aVirtualHost,anOdrNode,anOdrName,aDefaultAction,aWorkClassName,aProtocolType,aRule,aMembers):
   ...
   if (odrNode == None):
       print "Could not find node '"+anOdrNode+"'"

   odrName=findProxyServer(anOdrNode, anOdrName)
   if (getEnablePerformanceProfile() == "true"):
       print "findProxyServer = ", getSeconds()  
       
   if (odrName == None):
      print "Could not find ODR '"+anOdrName + "' on the node '"+anOdrNode
   
   if (findWorkClass(aWorkClassName,"routing",anOdrNode,anOdrName) != None):
   ...
   if (vhostName != None and odrNode != None and odrName != None):
       if (aDefaultAction != ""):
           ...
           addGSCRoutingRule(aWorkClassName,anOdrNode,anOdrName,aRule)
           if (getEnablePerformanceProfile() == "true"):
...
def createGSCSLAWorkClass(aVirtualHost,anOdrNode,anOdrName,aDefaultAction,aWorkClassName,aProtocolType,aRule,aMembers):
   ...
   if (findWorkClass(aWorkClassName,"sla",anOdrNode,anOdrName) != None):
       raise NameError("WARNING: WorkClass already exists; therefore, cannot call create.")
   if (getEnablePerformanceProfile() == "true"):
       print "findWorkClass = ", getSeconds()
   ...
   if (vhostName != None and odrNode != None and odrName != None and tcName != None):
       ...
       addGSCSLARule(aWorkClassName,anOdrNode,anOdrName,aRule)
       if (getEnablePerformanceProfile() == "true"):
...
def addGSCSLAMember(aWorkClassName,anOdrNode,anOdrName,aMembers):
   ...
   if (odrNode != None and odrName != None):
       slaWorkClass=findWorkClass(aWorkClassName,"sla",anOdrNode,anOdrName)
       if (getEnablePerformanceProfile() == "true"):
           print "findWorkClass = ", getSeconds()
...
def addGSCRoutingMember(aWorkClassName,anOdrNode,anOdrName,aMembers):
   ...
   if (odrNode != None and odrName != None):
       slaWorkClass=findWorkClass(aWorkClassName,"routing",anOdrNode,anOdrName)
       if (getEnablePerformanceProfile() == "true"):
           print "findWorkClass = ", getSeconds()
...
# @exception NameError  Is raised for bad input. The message is preceded with either WARNING: or ERROR: to indicate severity.
##   
def modifyGSCSLADefaultAction(aWorkClassName,anOdrNode,anOdrName,aDefaultAction):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true"
       start = time.clock()
...
# @exception NameError  Is raised for bad input. The message is preceded with either WARNING: or ERROR: to indicate severity.
##   
def modifyGSCRoutingDefaultAction(aWorkClassName,anOdrNode,anOdrName,aDefaultAction):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true"
       start = time.clock()
   ...
   if (odrName != None):
       if (aDefaultAction != ""):
           ...
           routingWorkClass = findWorkClass(aWorkClassName,"routing",anOdrNode,anOdrName)
           if (getEnablePerformanceProfile() == "true"):   
               print "findWorkClass = ", getSeconds()
           if (routingWorkClass != None):
...
# @exception NameError  Is raised for bad input. The message is preceded with either WARNING: or ERROR: to indicate severity.
##   
def modifyGSCSLAVirtualHost(aWorkClassName,anOdrNode,anOdrName,aVirtualHost):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true"
       start = time.clock()
...
# @exception NameError  Is raised for bad input. The message is preceded with either WARNING: or ERROR: to indicate severity.
##   
def modifyGSCRoutingVirtualHost(aWorkClassName,anOdrNode,anOdrName,aVirtualHost):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true"
       start = time.clock()
...
# @exception NameError  Is raised for bad input. The message is preceded with either WARNING: or ERROR: to indicate severity.
## 
def addGSCSLARule(aWorkClassName,anOdrNode,anOdrName,aRule):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true";
       start = time.clock()
...
# @exception NameError  Is raised for bad input. The message is preceded with either WARNING: or ERROR: to indicate severity.
## 
def addGSCRoutingRule(aWorkClassName,anOdrNode,anOdrName,aRule):
   showEndTime = "false"
   if (getTempTime() == -1 and getEnablePerformanceProfile() == "true"):
       showEndTime = "true";
       start = time.clock()
   ...
   if (odrName != None):
      ...
      errmsg = "ERROR: The ODR '"+anOdrName+"' on node '" + anOdrNode + "' does not exist in this WAS deployment."
      raise NameError(errmsg)
