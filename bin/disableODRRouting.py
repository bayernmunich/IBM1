...
#
#  disableODRRouting.py - disable routing through the ODR (when fronted by WebSphere plugin)
#
...
AdminConfig.create("Property",cell,[["name","ODR_Module_Routing_Policy"],["value","*=direct"]])
AdminConfig.save()
print "finished."
