...
CREATE TABLE @DbUser@.DBPROPTYPE (
	TYPE_ID			CHAR(16) NOT NULL,
	DESCRIPTION		NVARCHAR(254) NULL
);

CREATE TABLE @DbUser@.DBPROP (
...
CREATE TABLE @DbUser@.DBLONGPROP (
...
CREATE TABLE @DbUser@.DBBLOBPROP (
	VALUE_ID		NUMERIC(38, 0) NOT NULL,
	PROP_ID			INTEGER NOT NULL,
	TYPE_ID			CHAR(16) NOT NULL,
	ENTITY_ID		NUMERIC(38, 0) NOT NULL,
...
CREATE TABLE @DbUser@.DBCOMPPROP (
	VALUE_ID		NUMERIC(38, 0) NOT NULL,
	PROP_ID			INTEGER NOT NULL,
	ENTITY_ID		NUMERIC(38, 0) NOT NULL,
...
CREATE TABLE @DbUser@.DBENTREL (
	DESCENDANT_ID		NUMERIC(38, 0) NOT NULL,
	ANCESTOR_ID		NUMERIC(38, 0) NOT NULL
);


CREATE TABLE @DbUser@.DBKEYS (
...
CREATE TABLE @DbUser@.DBGRPREL (
	GRP_ID			NUMERIC(38, 0) NOT NULL,
